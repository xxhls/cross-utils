...
const UserAgent = window.navigator.userAgent || navigator.vendor || window.opera;
...
// ... existing code ...
//锦礼
export const isJinliMiniprogram = UserAgent.indexOf('wx54c5683ae3f8a574') !== -1;

//京购小程序
export const isJingGouMiniprogram = UserAgent.indexOf('wx91d27dbf599dff74') !== -1;
