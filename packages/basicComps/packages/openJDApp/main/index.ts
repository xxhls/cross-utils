...
declare global {
  ...
  export const openJDAPP = (args?: ArgsType, typeHandle?: 'layer' | string) => {
      ...
      const handle = (typeHandle?: 'layer' | string) => {
          const downLink = 'https://wqs.jd.com/downloadApp/download.html?channel=jd-m-xsg-sqzt';
      ...
      if(window.downLoadAppPlugin){
          ...
          try {
              loadjs('//wq.360buyimg.com/js/common/dest/wq.imk.downloadAppPlugin.min.js', {crossorigin: 'anonymous'}).then(()=>{
