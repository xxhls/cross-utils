...
class LocationHelper {
   ...
   * @return {*}
   */
  createPromise = (url: string, params = {}) => {
    return undefined;
  };
   ...
   * @return {*}
   */
  getAddressInfo = (): Promise<unknown> | undefined => {
    return new Promise(() => {});
  };
  /**
   ...
   * @returns
   */
  getLBSCacheAddress = (params?): Promise<unknown> | undefined => {
    return new Promise(() => {});
  };
   ...
   * @returns
   */
  getB2CCacheAddress = (params?): Promise<unknown> | undefined => {
    return new Promise(() => {});
  };
}
